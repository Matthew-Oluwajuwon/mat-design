  ...
  'inline-flex items-center justify-center font-medium transition-all gap-spacing-2 focus:ring-spacing-system-spacing-xxs ring-primary-200 disabled:pointer-event-none',
  {
    variants: {
      variant: {
        ...
        secondary: 'border border-primary-500 text-color-text-accent hover:bg-primary-50 active:bg-primary-100 disabled:text-gray-200 disabled:border-gray-200 disabled:bg-transparent',
        ghost: 'bg-transparent text-color-text-accent hover:bg-primary-50 active:bg-primary-100 disabled:text-gray-200 disabled:bg-transparent',
      },
      size: {
